...
async function main() {
    ...
    const tokenFactory = await getContractFactory("BatchTransferTool");

    const tokenCt = await tokenFactory.deploy();
    await tokenCt.deployed();

    console.log(`${"BatchTransferTool"} deployed to:`, tokenCt.address);
    ...
    Object.assign(output, {
        ...
        verifyData: {
            ...
            contract: "contracts/BatchTransferTool.sol:BatchTransferTool"
        }
    });
