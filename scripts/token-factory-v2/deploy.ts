...
async function main() {
  ...
  const tokenFactory = await getContractFactory("TokenFactoryV2");
  ...
  if (NODE_ENV && specialChains.includes(NODE_ENV)) {
    ...
    console.log(`${"TokenFactoryV2"} deployed to:`, tokenCt.address);
    const linkDeploy =
    ...
    Object.assign(output, {
      ...
      verifyData: {
        ...
        contract: "contracts/TokenFactoryV2.sol:TokenFactoryV2",
      },
    });
