...
async function main() {
    ...
    const tokenFactory = await getContractFactory("MintNftFactory");
    ...
    console.log(`${"MintNftFactory"} deployed to:`, tokenCt.address);
    ...
    Object.assign(output, {
        ...
        verifyData: {
            ...
            contract: "contracts/MintNftFactory.sol:MintNftFactory"
        }
    });
