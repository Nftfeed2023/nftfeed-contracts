...
async function main() {
    ...
    const tokenFactory = await getContractFactory("WrappedSharkie");
    const tokenCt = await tokenFactory.deploy();
    await tokenCt.deployed();

    console.log(`${"WrappedSharkie"} deployed to:`, tokenCt.address);
    ...
    Object.assign(output, {
        ...
        verifyData: {
            ...
            contract: "contracts/WrappedSharkie.sol:WrappedSharkie"
        }
    });
