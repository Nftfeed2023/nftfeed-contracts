...
async function main() {
    ...
    console.log(`-------------------`);
    console.log({ inputPools });
    console.log(`-------------------`);
    Object.assign(output, {
        DEPLOYER_ADDRESS: deployer.address,
    })

    const tokenFactory = await getContractFactory("StakeMultipleERC721");
    ...
    console.log(`${"StakeMultipleERC721"} deployed to:`, tokenCt.address);
    ...
    Object.assign(output, {
        ...
        verifyData: {
            ...
            contract: "contracts/StakeMultipleERC721.sol:StakeMultipleERC721"
        }
    });
